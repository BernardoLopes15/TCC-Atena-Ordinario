                                    ...
                                    <div className="flex justify-center flex-col flex-wrap">
                                        {
                                            ...
                                            psicologos.map((psicologo, index) => (
                                                <BoxPsicologo key={index} nome={psicologo.nm_psicologo} idade={mostrarIdade(psicologo.dt_nascimento.split('-').reverse().join('/'))} proficao={psicologo.nm_area_atuacao} image={Psicologo1} cidade={psicologo.nm_localizacao} data={psicologo.dt_cadastro.split('-').reverse().join('/')} />
                                            ))
                                            :
