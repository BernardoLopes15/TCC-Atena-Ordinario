          ...
          <article>
            ...
            <section className="px-4 py-8 md:pb-32 flex items-center justify-center objetivo">
              <div className="md:w-2/3 md:flex justify-between py-6">
                ...
                <div className="md:max-w-2xl content">
            ...
            <section className="px-4 py-8 md:py-32 flex items-center justify-center saude">
              <div className="md:w-2/3 flex flex-col-reverse md:flex-row justify-between py-6">
                <div className="md:max-w-2xl content">
                  ...
                  Zelar pelo seu bem-estar mental deve ser uma entre suas prioridades de vida, o seu estado mental é refletido em todas as áreas da sua vida, desde seu comportamento no trabalho até seu relacionamento familiar. <br/> <br/> Assista o vídeo para compreender melhor a importância de cuidar da sua saúde mental.
                  </p>
                </div>
                <div className="w-full md:w-96 h-64 flex items-center justify-center text-white bg-black">video aqui</div>
              </div>
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320" className='md:block hidden'><path fill="#fff" fill-opacity="1" d="M0,160L80,149.3C160,139,320,117,480,133.3C640,149,800,203,960,213.3C1120,224,1280,192,1360,176L1440,160L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"></path></svg>

            <section className="px-4 py-8 md:py-32 flex items-center justify-center tcc">
              <div className="md:w-2/3 flex flex-col-reverse md:flex-row justify-between py-6 content_tcc">
                <div className="md:max-w-2xl">
                  <h2 className="text-xl">The Golden Developers</h2>
                  <img src={logoEmpresa} alt="perfil" />
                  <p className="text-lg">
                  Zelar pelo seu bem-estar mental deve ser uma entre suas prioridades de vida, o seu estado mental é refletido em todas as áreas da sua vida, desde seu comportamento no trabalho até seu relacionamento familiar.Assista o vídeo ao lado para compreender melhor a importância de cuidar da sua saúde mental.
                  </p>
                </div>
              </div>
            </section>
      ...
      <>
        <header>
          <nav className="w-full h-20 flex items-center justify-center fixed  navbar">
            <img src={logonNavbar} className='img_navbar' alt="perfil"/>
            <div className="w-full px-6 md:w-2/3">
              <ul className="flex justify-between md:justify-end">
               <li><NavLink href="#project"> Projeto </NavLink></li>
               <li><NavLink href="#aboutUs"> Quem Somos</NavLink></li>
