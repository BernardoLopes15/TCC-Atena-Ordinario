        ...
        <main>
            <article>
                <div class="min-h-screen flex items-center justify-center login">
                    <div class="flex items-center justify-center rounded-xl bg-purple-500 content-login">
                        <div class="w-96 p-8 hidden md:block message">
                            <h2 class="text-right text-xl text-white">Proteja e empodere: encontre os melhores profissionais da saúde.</h2>
                        </div>
                        <div class="w-96 sm:border-2 sm:border-black rounded-xl bg-white loge ">
