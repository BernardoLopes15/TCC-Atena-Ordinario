            ...
            <article>
                <div className="min-h-screen flex items-center justify-center cadastro">
                      ...
                      <div className="  flex items-center justify-center " >
                        ...
                        <div className=" p-4 w-2/3 md:bg-white type-account ">
                                         ...
                                         <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="currentColor" class="bi bi-x-circle" viewBox="0 0 16 16" className="absolute cursor-pointer">
                                       ...
                                       <div className=" mt-6 flex items-center justify-center ">
                                        <Link to="/cadastro">
                                         <button className="btn w-60">Voltar</button>
                                         </Link>
                                         </div>
                                        </div>
