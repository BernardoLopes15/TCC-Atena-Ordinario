        ...
        <main>
            <article>
                <div className="min-h-screen flex items-center justify-center cadastro">
                    ...
                    <div className={`transition-blur duration-300 ${informationTermos && "blur-sm"}`}>
                      ...
                      <path fill-rule="evenodd" d="M.146 8.354a.5.5 0 0 1 0-.708l3-3a.5.5 0 1 1 .708.708L1.707 7.5H10.5a.5.5 0 0 1 0 1H1.707l2.147 2.146a.5.5 0 0 1-.708.708l-3-3z"/>
                        ...
                        <div className="flex justify-between content-form">
                         ...
                         <div className="w-auto ">
                            ...
                            <button className="py-2 h-10 text-white btn" type="submit" onClick={validarCamposPreenchidos} >Próximo</button>
                        ...
                        {
                                    informationTermos && <div className="fixed top-2  inset-0 flex items-center justify-center overflow-y-auto " >
                                        <div className="p-4 w-3/5 md:bg-white type-account ">
                                        ...
                                        <p className="font-bold mt-2 mb-2 text-3xl text-center">Termos e Condições de Uso</p> 
